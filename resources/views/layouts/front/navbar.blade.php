  <!-- Navbar -->
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-light bg-white flex-column border-0 nav_cus  ">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <a class="navbar-brand fw-bold fs-3 m-0 p-0 flex-shrink-0 order-0" href="./index.html">
                        <div class="d-flex align-items-center">
                            <img  class="img-fluid mainlogo" src="{{ asset('assets/images/logos/555-05 copy222.webp') }}" alt="HTML Bootstrap Template by Pixel Rocket">
